...
\emph{ModelElement Pairs} osztályban tárolja, a párosítás során az egyes
elemeket a mélységükkel együtt egy \emph{ModelElement Depth} osztályba
...
gyerekeit is hozzá tudjuk adni, ezt valósítja meg a \emph{ModelElement Fifo}
...
már csak a hibakezelést megvalósító \emph{Delta Initialisation Exception} és
\emph{Document Creation Exception} osztályok maradtak.
