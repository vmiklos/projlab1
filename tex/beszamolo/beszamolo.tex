...
készülékhez elérhet\H{o} egy zárt forráskódú szoftver \cite{Clever Chek Software}, amellyel le lehet
...
így azt nekem kell elkészíteni. Megtaláltam \cite{Kai-Wen Kan} az audió kábel
kiosztását (m\H{u}szer fel\H{o}li vég), a a soros port kiosztását \cite{RS-232}
...
virtuális gépen végzem két szoftver használatával. A VSPE \cite{VSPE} létrehoz
egy virtuális portot, majd a SerialMon \cite{SerialMon} beépül a virtuális és a valós
...
Elkészült az Erlang verzió. Végül kiderült, hogy az volt a probléma,
hogy a C driver \texttt{open(path, O\_RDWR | O\_NOCTTY | O\_NONBLOCK)} helyett
\texttt{open(path, O\_RDWR)} hívást használt, és ezért nem jöttek meg az
üzenetek Erlangban mikor olvasni akartam a soros portról.
...
\bibitem{Clever Chek Software} Clever Check Software, http://www.simplediagnostics.com/\-documents/\-59.html

\bibitem{Programming Erlang} Joe Armstrong: Programming Erlang, http://www.pragprog.com/titles/jaerlang/programming-erlang

\bibitem{Kai-Wen Kan} Kai-Wen Kan: Development and evaluation of a home telehealth system for diabetic patients, http://designer.mech.yzu.edu.tw/\-article/\-articles/\-thesis/\-Master\_95KanKaiWen/\-PDF/\-(2006-{}10-{}31)\%20Chapter\%202.\%20Integration\%20of\%20the\%20distributed\%20data\%20server\%20 with\%20the\%20vital\%20sign\%20meter.pdf

\bibitem{RS-232} PC serial port (RS-232 DE9) pinout, http://pinouts.ru/\-SerialPorts/\-Serial9\_pinout.shtml

\bibitem{VSPE} VSPE: tool for serial ports emulation, http://www.eterlogic.com/\-Products.VSPE.html

\bibitem{SerialMon} SerialMon: A free RS232 serial port monitor/sniffer software for Windows, http://www.serialmon.com/
